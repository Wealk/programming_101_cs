...
namespace Programming101CS.Syllabus.Chapters {
    internal static class Chapter03_04 {
        ...
        private static string GetExercices() {
            var message = new StringBuilder();
            message.AppendLine("a) Implementa una función privada \"StringToUpperCase\" que dado un string devuelva una lista de chars con el mismo string pero con las letras en mayúsculas utilizando un \"foreach\" y la función char.ToUpperInvariant(item). Prueba la función con el mensaje \"Hola mundo\" mostrando el texto antes y después por consola:");
            ...
            message.AppendLine("\nc) Implementa una función protected \"GetNextEvenNumber\" que dado un número entero, y utilizando la función anterior, te de el número par más próximo por arriba, en caso de que no sea par y el propio número si es par. Prueba la función con los mismos valores anteriores:");
